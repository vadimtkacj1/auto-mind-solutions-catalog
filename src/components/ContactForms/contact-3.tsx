...
export default function Contact3({
  ...
  phone = '470-601-1911',
  email = 'https://veilmail.io/irish-geoff',
  address = '654 Sycamore Avenue, Meadowville, WA 76543',
  imageUrl = 'https://pagedone.io/asset/uploads/1696488602.png',
  formAction = 'https://fabform.io/f/xxxxx',
  className = '',
}: Contact3Props = {}) {
              ...
              <div className="relative h-full">
                ...
                <div className="absolute bottom-0 w-full lg:p-11 p-5">
                  <div className="bg-white rounded-lg p-6 block">
                    <a href={`tel:${phone}`} className="flex items-center mb-6">
                      ...
                      <h5 className="text-black text-base font-normal leading-6 ml-5">{phone}</h5>
                    </a>
                    <a href={email} className="flex items-center mb-6">
                      <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <h5 className="text-black text-base font-normal leading-6 ml-5">{email}</h5>
                    </a>
                    <a href="#" className="flex items-center">
                      ...
                      <h5 className="text-black text-base font-normal leading-6 ml-5">{address}</h5>
                    </a>
                  </div>
                </div>
              </div>
                ...
                <div className="flex">
                  <div className="flex items-center mr-11">
                    ...
                    <label htmlFor="radio-group-1" className="flex items-center cursor-pointer text-gray-500 text-base font-normal leading-6">
                      <span className="border border-gray-300 rounded-full mr-2 w-4 h-4 ml-2"></span> אימייל 
                    </label>
                  </div>
                  <div className="flex items-center">
                    ...
                    <label htmlFor="radio-group-2" className="flex items-center cursor-pointer text-gray-500 text-base font-normal leading-6">
                      <span className="border border-gray-300 rounded-full mr-2 w-4 h-4 ml-2"></span> טלפון 
                    </label>
                  </div>
                </div>
              </div>
